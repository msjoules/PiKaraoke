...
A BIG THANKS to the origninal creator, Vicwomg https://github.com/vicwomg/pikaraoke.git!  
...
My modifications focus mainly on the interface and my personal preferences:
...
If for some reason the app hangs and you can't restart it, you can issue the following one-liner in linux:
...
## Screenshots
<p style='font-size:8px'>(from this repository)</p>

### TV

<p align='left'>
<img src='./static/images/splash.png' alt='splash-screen' style='width:600px;height:250px'>
</p>

### Web interface

<div style="display: flex">
<img src='./static/images/pikaraoke_nowplaying.png'  alt='pikaraoke_nowplaying' style='width:250px;height:300px'>
<img src='./static/images/queue.png'  alt='queue' style='width:250px;height:200px'>
<img src='./static/images/search.png'  alt='search_box' style='width:250px;height:200px'>
</div>
<div style="display: flex">
<img src='./static/images/yt_search.png'  alt='yt_search' style='width:250px;height:430px'>
<img src='./static/images/browse.png'  alt='browse' style='width:250px;height:310px'>
<img src='./static/images/storage.png'  alt='storage' style='width:250px;height:300px'>
</div>
<img src='./static/images/username.png'  alt='username' style='width:250px;height:200px'>
...
Python versions between 3.8 to 3.11 is necessary
